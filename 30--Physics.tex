...
% mpemcksi/ipemcksi
% Physics - Classical Electromagnetism - Coloumb's Constant in SI form
% 
%          1
%   k = --------
%       4 pi e_0
%
\newcommand{ \mpemcksi }[0]{ \dfrac{ 1 }{ 4 \pi \epsilon_0 } }
\newcommand{ \ipemcksi }[0]{ \frac{ 1 }{ 4 \pi \epsilon_0 } }

% mpemcklh/ipemcklh
% Physics - Classical Electromagnetism - Coloumb's Constant in Lorentz-Heaviside form
% 
%        1
%   k = ----
%       4 pi
% 
\newcommand{ \mpemcklh }[0]{ \dfrac{ 1 }{ 4 \pi } }
\newcommand{ \ipemcklh }[0]{ \frac{ 1 }{ 4 \pi } }
