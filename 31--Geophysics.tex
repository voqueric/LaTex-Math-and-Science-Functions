...
% DESCRIPTION of 31--Geophysics.tex
% ==========
%
...
% mpgrn/ipgrn
% Geophysics - Magma Displacement - Reynold's Number
% 
%         w r v
%   R_e = -----
%           e
%
\newcommand{ \mpgrn }[0]{ \dfrac{w \rho v_{max}}{\eta} }
\newcommand{ \ipgrn }[0]{ \frac{w \rho v_{max}}{\eta} }


% mpgnavs/ipgnavs
% Geophysics - Magma Displacement - Navier Stoke's in Single Dimension
% 
%      d               d               d^2  
%   r --- v(a, t) = - --- P(b, t) + e ----- v(a, t) + r g
%     d t             d b             d a^2
%
%   arg a: velocity component variable
%   arg b: pressure component variable
\newcommand{ \mpgnavs }[2]{ - \mcpdelb{z}{}{P( #2 ,t)} + \eta \mcpdelb{x}{2}{v_z(#1,t)} + \rho g }
\newcommand{ \ipgnavs }[2]{ - \icpdelb{z}{}{P( #2 ,t)} + \eta \icpdelb{x}{2}{v_z(#1,t)} + \rho g }


% mpgnavsv/ipgnavsv
% Geohysics - Magma Displacement - Navier Stoke's in Vector Form
% 
%      d  -                 -     -
%   r --- v = - n P + e n^2 v + r g
%     d t
%
\newcommand{ \mpgnavsv }[0]{ - \nabla P + \eta \nabla^2 \mvnteb{ v } + \rho \mvnteb{ g } }
\newcommand{ \ipgnavsv }[0]{ - \nabla P + \eta \nabla^2 \ivnteb{ v } + \rho \ivnteb{ g } }
